...
def caught_speeding(speed, is_birthday):
    ...
    if is_birthday == True:
        birthday_modifier = 5
    if speed <= 60 + birthday_modifier:
        return 0
    if speed <= 80 + birthday_modifier:
        return 1
    else:
        return 2
...
def alarm_clock(day, vacation):
    ...
    weekend_alarm = "10:00"
    no_alarm = "off"
    if vacation == False and is_weekday == True:
        return work_alarm
    elif vacation == False and is_weekday == False:
        return weekend_alarm
    elif vacation == True and is_weekday == True:
        return weekend_alarm
    elif vacation == True and is_weekday == False:
        return no_alarm
...
def love6(a, b):
    ...
    if a > b:
        ...
        return False
    difference = abs(bigger_num - smaller_num)
    if difference == 6:
        return True
    return False
